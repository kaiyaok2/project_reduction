...
MAIN_JAR="target/commons-csv-1.11.1-SNAPSHOT.jar"
TEST_JAR="target/commons-csv-1.11.1-SNAPSHOT-tests.jar"
MERGED_JAR="target/commons-csv-1.11.1-SNAPSHOT-merged.jar"
